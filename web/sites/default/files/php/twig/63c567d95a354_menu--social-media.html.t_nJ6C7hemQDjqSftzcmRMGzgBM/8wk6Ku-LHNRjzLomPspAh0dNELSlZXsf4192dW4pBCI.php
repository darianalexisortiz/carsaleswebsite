...
/* themes/custom/b5carssale/templates/navigation/menu--social-media.html.twig */
class __TwigTemplate_33028549addba1720dd73a8d3d19650a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) > 0)) ? ("dropdown-item") : (""))];
    ...
    ";
                ...
                ob_start(function () { return ''; });
                echo "<span>";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "title", [], "any", false, false, true, 70), 70, $this->source), "html", null, true);
                echo "</span>";
                $context["link_text"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
                // line 71
                echo "      ";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getLink($this->sandbox->ensureToStringAllowed(($context["link_text"] ?? null), 71, $this->source), $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "url", [], "any", false, false, true, 71), 71, $this->source), ["class" => ($context["link_class"] ?? null)]), "html", null, true);
                echo "
    ";
            }
            // line 73
...
";
    ...
    {
        return "themes/custom/b5carssale/templates/navigation/menu--social-media.html.twig";
    }
    ...
    {
        return array (  179 => 73,  173 => 71,  166 => 70,  161 => 68,  156 => 67,  154 => 66,  149 => 65,  147 => 62,  145 => 61,  143 => 58,  142 => 57,  141 => 56,  140 => 55,  139 => 54,  138 => 53,  136 => 52,  134 => 49,  133 => 47,  131 => 46,  128 => 45,  113 => 44,  102 => 40,  93 => 38,  88 => 37,  84 => 35,  78 => 33,  75 => 32,  72 => 31,  69 => 30,  54 => 29,  49 => 43,  44 => 27,  41 => 22,  39 => 21,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/custom/b5carssale/templates/navigation/menu--social-media.html.twig", "/home4/isosite/public_html/mazzuchellirastorza_html/mazzuchellirastorza/themes/custom/b5carssale/templates/navigation/menu--social-media.html.twig");
    }
