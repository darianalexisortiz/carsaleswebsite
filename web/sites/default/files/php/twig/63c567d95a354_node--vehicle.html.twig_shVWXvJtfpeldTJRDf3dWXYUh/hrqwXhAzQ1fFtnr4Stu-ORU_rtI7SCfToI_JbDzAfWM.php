...
/* themes/custom/b5carssale/templates/content/node--vehicle.html.twig */
class __TwigTemplate_94a3757541cd90a4e00f529f31145f82 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<article";
  ...
  ";
        ...
        if ((($context["view_mode"] ?? null) == "teaser")) {
            // line 83
            echo "    <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", [0 => "node__content"], "method", false, false, true, 83), 83, $this->source), "html", null, true);
            echo ">
      ";
            // line 84
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image", [], "any", false, false, true, 84), 0, [], "any", false, false, true, 84), 84, $this->source), "html", null, true);
            echo "
      <div class=\"content\">
        ";
            // line 86
        ...
        ";
            // line 93
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 93, $this->source), "field_image"), "html", null, true);
            echo "
      </div>
    </div>
  ";
    ...
    <div class=\"col-md-3\">
    <div class=\"form\">
      <h2>Contactacta con nosotrostar</h2>
      ";
            // line 106
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ["#type" => "webform", "#webform" => "contact", "#default_data" => ["subject" => "Quiero mas información sobre [current-page:title]"]], "html", null, true);
            echo "
    </div>
    </div>
  <div>
...
";
    ...
    {
        return "themes/custom/b5carssale/templates/content/node--vehicle.html.twig";
    }
    ...
    {
        return array (  119 => 111,  111 => 106,  102 => 100,  97 => 97,  90 => 93,  85 => 92,  77 => 89,  72 => 88,  70 => 87,  66 => 86,  61 => 84,  56 => 83,  54 => 82,  50 => 81,  46 => 80,  44 => 77,  43 => 76,  42 => 75,  41 => 74,  40 => 73,  39 => 71,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/custom/b5carssale/templates/content/node--vehicle.html.twig", "/home4/isosite/public_html/mazzuchellirastorza_html/mazzuchellirastorza/themes/custom/b5carssale/templates/content/node--vehicle.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 71, "if" => 82);
        static $filters = array("clean_class" => 73, "escape" => 80, "without" => 93);
